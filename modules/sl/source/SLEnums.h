...
enum SLSceneID
{
    ...
    SID_VideoTrackFeature2DMain = 58,
    SID_VideoTrackFaceMain      = 59,
    SID_VideoTrackFaceScnd      = 60,
#ifdef SL_BUILD_WITH_MEDIAPIPE
    SID_VideoTrackMediaPipeHandsMain = 61,
#endif
    SID_VideoSensorAR = 62,
#ifdef SL_BUILD_WAI
    SID_VideoTrackWAI = 63,
#endif

    SID_RTMuttenzerBox = 64,
    SID_RTSpheres      = 65,
    SID_RTSoftShadows  = 66,
    SID_RTDoF          = 67,
    SID_RTLens         = 68,
    SID_RTTest         = 69,

    SID_ErlebARBernChristoffel      = 70,
    SID_ErlebARBielBFH              = 71,
    SID_ErlebARAugustaRauricaTmp    = 72,
    SID_ErlebARAugustaRauricaTht    = 73,
    SID_ErlebARAugustaRauricaTmpTht = 74,
    SID_ErlebARAventicumAmphiteatre = 75,
    SID_ErlebARAventicumCigognier   = 76,
    SID_ErlebARAventicumTheatre     = 77,
    SID_ErlebARSutzKirchrain18      = 78,

    SID_ParticleSystem_First       = 79,
    SID_ParticleSystem_Demo        = 80,
    SID_ParticleSystem_DustStorm   = 81,
    SID_ParticleSystem_Fountain    = 82,
    SID_ParticleSystem_Sun         = 83,
    SID_ParticleSystem_RingOfFire  = 84,
    SID_ParticleSystem_FireComplex = 85,

    SID_Benchmark1_LargeModel                  = 86,
    SID_Benchmark2_MassiveNodes                = 87,
    SID_Benchmark3_NodeAnimations              = 88,
    SID_Benchmark4_SkinnedAnimations           = 89,
    SID_Benchmark5_ColumnsNoLOD                = 90,
    SID_Benchmark6_ColumnsLOD                  = 91,
    SID_Benchmark7_JansUniverse                = 92,
    SID_Benchmark8_ParticleSystemFireComplex   = 93,
    SID_Benchmark9_ParticleSystemManyParticles = 94,
