/**
 * \file      AppDemoSceneVolumeRayCastLighted.cpp
...
void AppDemoSceneVolumeRayCastLighted::registerAssetsToLoad(SLAssetLoader& al)
{
    ...
    al.addProgramToLoad(_sp,
                        AppCommon::shaderPath + "VolumeRenderingRayCast.vert",
                        AppCommon::shaderPath + "VolumeRenderingRayCastLighted.frag");
}
//-----------------------------------------------------------------------------
//! After parallel loading of the assets the scene gets assembled in here.
void AppDemoSceneVolumeRayCastLighted::assemble(SLAssetManager* am,
                                                SLSceneView*    sv)
{
    ...
    scene->addChild(new SLNode(new SLBox(
      am,
      -1,
      -1,
      -1,
