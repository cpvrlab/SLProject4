...
AppDemoSceneErlebARAugustaTmpTht::AppDemoSceneErlebARAugustaTmpTht()
  : AppScene("Augusta Raurica Temple and Theatre AR")
{
                                                ...
                                                SLSceneView*    sv)
{
    ...
    AppDemo::devLoc.nameLocations().push_back(SLLocation("Center of theatre, Origin",
                                                         47,
                                                         31,
                                                         59.461,
                                                         7,
                                                         ...
                                                         19.446,
                                                         282.6));
    AppDemo::devLoc.nameLocations().push_back(SLLocation("Treppe Tempel",
                                                         47,
                                                         31,
                                                         58.933,
                                                         7,
                                                         ...
                                                         16.799,
                                                         290.5 + 1.7));
    AppDemo::devLoc.nameLocations().push_back(SLLocation("Abzweigung (Dolendeckel)",
                                                         47,
                                                         31,
                                                         57.969,
                                                         7,
                                                         ...
                                                         17.946,
                                                         286.5 + 1.7));
    AppDemo::devLoc.nameLocations().push_back(SLLocation("Marker bei Tempel",
                                                         47,
                                                         31,
                                                         59.235,
                                                         7,
                                                         ...
                                                         15.161,
                                                         293.1 + 1.7));
    AppDemo::devLoc.nameLocations().push_back(SLLocation("Theater 1. Rang Zugang Ost",
                                                         47,
                                                         31,
                                                         59.698,
                                                         7,
                                                         ...
                                                         20.518,
                                                         291.0 + 1.7));
    AppDemo::devLoc.nameLocations().push_back(SLLocation("Theater 1. Rang Nord",
                                                         47,
                                                         32,
                                                         0.216,
                                                         7,
